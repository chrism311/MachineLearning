...
Scikit-learn \todo{Create the citation for scikit-learn.  This can be obtained from the website} is a Python-based machine learning library \cite{scikit} that contains many tools and algorithms that are used to make predictions when introduced to new data. 
...
number of closest training examples. The neighbors weigh in, in the decision of which class that the data points will fall under. \todo{needs some work}
